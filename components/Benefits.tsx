...
export default function Benefits() {
  return (
    <div className="bg-gray-900 py-24 sm:py-32 text-white w-full" id='benefits'>
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-3">
          <div>
            <h2 className="mt-2 text-4xl font-bold tracking-tight">Benefits</h2>
            <p className="font-semibold leading-7 text-indigo-600 text-4xl">Good health is good business</p>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto grid max-w-2xl grid-cols-1 lg:mx-0 lg:max-w-none lg:grid-cols-2">
            <div className="flex flex-col pb-10 sm:pb-16 lg:pb-0 lg:pr-8 xl:pr-20">
              <p className="mt-2 text-4xl font-bold tracking-tight">Key <span className='text-amber-500'>Employee</span>  Benefits</p>
              <figure className="mt-10 flex flex-auto flex-col justify-between">
                <blockquote className="text-lg leading-8 text-white">
                  <ul className="list-disc px-6 lg:px-8">
                    <li>24/7 telemedicine & tele-behavioral health for entire household or $0 copay.</li>
            ...
            <div className="flex flex-col border-t border-white/10 pt-10 sm:pt-16 lg:border-l lg:border-t-0 lg:pl-8 lg:pt-0 xl:pl-20">
              <p className="mt-2 text-4xl font-bold tracking-tight">Key <span className='text-amber-500'>Employer</span> Benefits</p>
              <figure className="mt-10 flex flex-auto flex-col justify-between">
                <blockquote className="text-lg leading-8 text-white">
                <ul className="list-disc px-6 lg:px-8">
